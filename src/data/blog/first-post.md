...
- 두번째는 생각의 완성도, 그리고 단계별 빌드업을 하는데 있어 단기 기억 공간 (short term memory)은 한계가 명확하다는것을 깨달으면서였다.
...
자기객관화에도 도움이 되고 무엇보다 가끔 누군가와의 대화에서 내가 감정을 드러내는 순간에 '이게 정말 의미가 있는 건지?' 생각해보고 어느 정도 조절이 되었다.
